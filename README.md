...
| **STT / TTS** | Groq Whisper / Deepgram Aura-2 |
| **Avatar** | Trugen AI |
| **Recall** | Recall.ai (Webpage Bot Automation) |
...
# Recall.ai Automation
RECALL_API_URL=https://us-west-2.recall.ai/api/v1/bot/
RECALL_API_TOKEN=...
AVATAR_VIDEO_STREAM=https://.../serverless/just-avatar/
RECALL_WEBHOOK_URL=https://.../api/v1/webhook
```
