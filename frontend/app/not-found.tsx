      ...
      <div className="flex flex-col items-center gap-6 text-center max-w-md">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-16 h-16 bg-[#00E3AA]/10 border border-[#00E3AA]/20 rounded-2xl flex items-center justify-center">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard"
            className="px-6 py-2.5 bg-[#00E3AA] text-black text-sm font-bold rounded-xl hover:brightness-110 transition-all active:scale-[0.98]"
          >
            Go to Dashboard
          </Link>
          <Link
