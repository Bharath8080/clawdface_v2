...
export function ContactCTASection() {
  return (
    <section id="contact" className="py-28 px-6 bg-[#0a0a0a] relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#00E3AA]/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="inline-flex items-center gap-2 bg-[#00E3AA]/10 border border-[#00E3AA]/20 px-4 py-2 rounded-full mb-8">
            <span className="w-2 h-2 rounded-full bg-[#00E3AA] animate-pulse" />
            <span className="text-[#00E3AA] text-sm font-semibold">Support</span>
          </div>

          <h2 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white leading-[1.05] mb-6">
            We are here <br />
            <span className="text-[#00E3AA]">to help.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="mailto:support@clawdface.ai">
              <button className="px-8 py-4 bg-[#00E3AA] text-black rounded-xl font-bold hover:bg-[#00c996] transition-colors text-base">
